...
//  Fetch banners
	$BANNERS->events = NULL;
	$sql = mysqli_query($CONNECTION, "SELECT eventID, date_start AS startDate, date_end AS endDate, MONTH(date_start) AS startMonth, YEAR(date_start) AS startYear, location, heading_".$lang_acr." AS heading, text_".$lang_acr." AS text FROM events WHERE active = 1 AND date_start>CURDATE() ORDER BY date_start ASC LIMIT 1");
	if (mysqli_num_rows_wrapper($sql))
	{
		$BANNERS->events = mysqli_fetch_object_wrapper($sql);
		$BANNERS->events->has_text = (bool) $BANNERS->events->text;
	}
...
<body class="<?= $bodyClass ?>">
	...
	<div class="main-container margin-md-t-50">
		<div class="welcome-note">
			...
			<div id="backgroundImage" class="background-image-placeholder homepage-special">
				<div class="background-image margin-md-t-20"></div>
			</div>
	
			<div class="overlay"></div>
			<div class="content text-center">
				<div class="heading strong heading-special md-heading-special"> 
					<div class="text"><div><?php echo $lang->workshop_wka ?></div></div>
				</div>				
				<div class="margin-t-10 md-dn text-left">
					<div class="container-fluid">
						<div class="row margin-t-20">							
							<div id="elements" class="col-md-push-5 col-md-6 col-sm-push-5 col-sm-6 text-left margin-t-50 cl-elems">								
								<h3 id="headingRight" class="strong dark-heading"><?= $lang->talent_cantBeTaught ?>.</h3>
								<div class="subheading"><?= $lang->join_ourOnline ?>.</div>
								<div class="marked-text strong uppercase margin-t-20"><?= $lang->lets_haveFun ?>!</div>
								<div class="margin-t-20">
									<a href="<?= $domain ?>packages">
										<div id="subscribeBtn" class="btn-welcome color-theme btn-ord small"><i class="fa fa-video-camera"></i> <span class="padding-l-5"><?= $lang->scrbForMyWS ?></span></div>
									</a>
								</div>
							</div>
						</div>							
			...
			<div class="banners-right-placeholder md-dn">		
				...
				<div class="pinned-news margin-t-20 pinned-news-2">
					<div class="strong text-large padding-t-20 font-eminenz">
						<i class="fa fa-calendar"></i> <?php echo $lang->next_Workshop ?>
					</div>
					<div class="divider"></div>
					<div class="padding-r-10 text-center">						
						<img src="<?= $FILE ?>img/gallery/img1.jpg" style="width: 80%">						
					</div>		
					<!--			
					<div class="padding-t-10 color-theme strong"><?= $BANNERS->workshop->heading ?></div>	
					-->				
					<div class="smaller margin-t-10"><span class="fa fa-calendar"></span> <?= make_date(-1,"2017-03-13"); ?></div>								
				</div>	

				<div class="pinned-news margin-t-20 pinned-news-3">
					<div class="strong text-large padding-t-10 font-eminenz">
						<i class="fa fa-paint-brush"></i> <?php echo $lang->our_Partners ?>
					</div>
					<div class="divider"></div>
					<div class="image-optimised">
						<a href="http://stamperia.com/" target="_blank">
							<img src="<?= $FILE ?>img/partners/stamperia1.jpg">
						</a>
					</div>				
				</div>	

				<div class="pinned-news margin-t-20 pinned-news-1">
					<div class="strong text-large padding-t-10 font-eminenz">
						<i class="fa fa-calendar"></i> <?php echo $lang->upcoming_event ?>
					</div>
					<div class="divider"></div>
					<?php if ($BANNERS->events) { ?>
					
					<?php if ($BANNERS->events->has_text) { ?>
					<a class="link-ord color-theme" href="<?= $FILE ?>calendar?eventID=<?= $BANNERS->events->eventID ?>">
						<div><?= $BANNERS->events->heading ?></div>
					</a>
					<?php } else { ?>
					<a class="link-ord color-theme" href="<?= $FILE ?>calendar?month=<?= $BANNERS->events->startMonth ?>&year=<?= $BANNERS->events->startYear ?>">
						<div><?= $BANNERS->events->heading ?></div>
					</a>
					<?php }; ?>
					<div class="smaller margin-t-10"><span class="fa fa-calendar"></span> <?= make_date(-1,$BANNERS->events->startDate); ?></div>
					<div class="smaller">
						<span class="fa fa-map-marker"></span> <span class="strong"><?= $BANNERS->events->location ?></span>
					</div>
					<?php } else { ?>					
					<?php echo $lang->currently_noEvents ?>.
					<?php }; ?>
				</div>
	...
	<div class="container md-db dn">
		<div class="divider"></div>
		<div class="row margin-t-20 margin-b-20">
			<div class="col-sm-12 col-xs-12 padding-l-20 text-center">
				<a href="<?= $domain ?>packages">
					<div class="paper-btn small"><i class="fa fa-video-camera"></i> <?php echo $lang->sub_ToMyWS ?></div>
				</a>
			</div>
		</div>	
	</div>

	<div class="container-fluid padding-md-t-none padding-t-30 padding-b-30 bg-sepia">
		<div class="row">
		...
		<div class="row text-center margin-t-40">
			<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
				<a href="<?php echo $domain ?>workshops">
					<div class="paper-btn uppercase"><i class="fa fa-paint-brush"></i> <?php echo $lang->workshops ?></div>
				</a>
				<div class="margin-l-20" style="display: inline-block;">
					<a href="<?php echo $domain ?>about">					
						<div class="paper-btn uppercase"><i class="fa fa-hand-o-right"></i> <?php echo $lang->about ?></div>
					</a>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-sm-12 col-xs-12 margin-t-10">
				 ...
				 <div class="md-text-center margin-md-t-20">
					 <a href="<?= $domain ?>packages">
						<div class="btn-welcome color-theme btn-ord small"><i class="fa fa-video-camera"></i> <span class="padding-l-5"><?php echo $lang->sub_ToMyWS ?></span></div>
					</a>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid paint-brush-back md-paint-brush-back">
		<div class="container margin-b-90 margin-t-20">
			<div class="row">
				<div class="col-md-4 col-xs-12 col-sm-12">	
					<div class="trait-placeholder">					
						<div class="special-background padding-b-20 padding-t-20">
							<div>
								<h3 class="strong"><i class="fa fa-diamond"></i> <?php echo $lang->quality ?></h3>
							</div>
							<div class="text padding-l-30"><?php echo $INDEX_4 ?></div>
						</div>
					</div>					
				</div>
				<div class="col-md-4 col-xs-12 col-sm-12">
					<div class="trait-placeholder">					
						<div class="special-background padding-b-20 padding-t-20">
							<div>
								<h3 class="strong"><i class="fa fa-magic"></i> <?php echo $lang->enchant_magic ?></h3>
							</div>
							<div class="text padding-l-30"><?php echo $INDEX_5 ?></div>
						</div>
					</div>					
				</div>
				<div class="col-md-4 col-xs-12 col-sm-12">
					<div class="trait-placeholder">					
						<div class="special-background padding-b-20 padding-t-20">
							<div>
								<h3 class="strong"><i class="fa fa-paint-brush"></i> <?php echo $lang->popular_workshops ?></h3>
							</div>
							<div class="text padding-l-30"><?php echo $INDEX_6; ?></div>
						</div>
					</div>					
				</div>
			</div>
			...
			<div class="row margin-t-20">
				<div class="col-md-4 col-xs-12 col-sm-12">
					<div class="trait-placeholder">					
						<div class="special-background padding-b-20 padding-t-20">
							<div>
								<h3 class="strong"><i class="fa fa-thumbs-o-up"></i> <?php echo $lang->satisfied_customers ?></h3>
							</div>
							<div class="text padding-l-30"><?php echo $INDEX_7 ?></div>
						</div>
					</div>						
				</div>
				<div class="col-md-4 col-xs-12 col-sm-12">
					<div class="trait-placeholder">					
						<div class="special-background padding-b-20 padding-t-20">
							<div>
								<h3 class="strong"><i class="fa fa-bell-o"></i> <?php echo $lang->many_news ?></h3>
							</div>
							<div class="text padding-l-30"><?php echo $INDEX_1 ?></div>
						</div>
					</div>					
				</div>
				<div class="col-md-4 col-xs-12 col-sm-12">
					<div class="trait-placeholder">					
						<div class="special-background padding-b-20 padding-t-20">
							<div>
								<h3 class="strong"><i class="fa fa-smile-o"></i> <?php echo $lang->work_relax ?></h3>
							</div>
							<div class="text padding-l-30"><?php echo $INDEX_8 ?></div>
						</div>
					</div>					
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row margin-t-20">
				...
				<div class="col-md-push-1 col-md-2 col-lg-3 col-xs-12 col-sm-12 text-center margin-md-t-20">
					<a href="<?= $FILE ?>about"><div class="paper-btn uppercase"><i class="fa fa-rocket"></i> <?php echo $lang->learn_more ?></div></a>
				</div>
			</div>
		</div>
	</div>	
	...
	<div class="container text-center margin-t-40">
		<div class="row">
			...
			<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 text-center">
				<div class="col-md-3 col-xs-12 col-sm-6 margin-md-b-20">
