...
<body class="<?= $bodyClass ?>">
		...
		<div class="welcome-note" style="background: white; height: 500px">
			<div class="content color-theme content-error" style="color: black;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-3 col-xs-12 col-sm-12 large"><span class="large"><i class="fa fa-shield fa-5x color-theme"></i></span></div>
						<div class="col-md-9 col-xs-12 col-sm-12 margin-md-t-none margin-t-50">
							<h1 class="uppercase strong"><?= $lang->h500; ?></h1>
							<label class="label label-danger"><?= $lang->error ?> 500</label>
							<div class="text-faded margin-t-10"><?= $lang->_500; ?></div>
						</div>
					</div>
				</div>
	...
	<?php print_HTML_data("script","500") ?>
