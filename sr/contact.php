	...
	<div class="main-container margin-md-t-60">
		<div class="welcome-note welcome-note-min welcome-artist">
			...
			<div class="content text-center">
				<div class="heading strong heading-special heading-special-rest md-heading-special padding-l-60 padding-r-60" style="display: inline-block;"> <?php echo $lang->contact ?> </div>			
			</div>
		</div>
	</div>
	<!-- /Main Container -->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 text-center">
					<h1 class="strong"><?php echo $lang->always_forNewContact ?></h1>
				</div>
			</div>			
		</div>
	</div>
			...
			<div class="row">
				...
				<div class="col-md-8 col-xs-12 col-sm-12">
					...
					<div class="margin-t-10 text-right">
						<div id="sendEmail" data-success-send="<?= $lang->soonContact ?>" class="btn-initiator-send small"><i class="fa fa-send"></i> <span class="padding-l-5"><?php echo $lang->send_message ?></span></div>
					</div>
				</div>
				<!-- /Contact Form -->
